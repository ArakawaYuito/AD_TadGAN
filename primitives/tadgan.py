...
from primitives.timeseries_errors import reconstruction_errors
...
def score_anomalies(y: ndarray, y_hat: ndarray, critic: ndarray,
    ...
    return final_scores, true, predictions
